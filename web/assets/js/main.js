$(document).ready(function () {
    ...
    setInterval(function () {
        ...
        days_span.innerHTML = '<span class="number">' + days + '</span>' + '<span class="unit script">D&iacute;as</span>';
    ...
    map.addMarker({
        ...
        lng: -60.8046123,
        verticalAlign: 'top',
        title: 'Ubicaci&oacute;n del sal&oacute;n',
        infoWindow: {
            content: '<div class="note">Ceremonia</div><h4 class="map-title script">La Arbolada Eventos</h4><div class="address"><span class="region">Catamarca 1901</span><br><span class="postal-code">2000</span><br><span class="city-name">Funes</span></div>'
        }
